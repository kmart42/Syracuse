            ...
            @Override public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override public void onSuccess(final Uri uri) {
                        ...
                        DatabaseReference postsRef = database.getReference("Movies");
                        DatabaseReference newPostRef = postsRef.push();
                        newPostRef.setValue(new MessageRecyclerAdapter.PostModel(title1.getText().toString(),description.getText().toString(),uri.toString(),
                                rating.getText().toString(), stars.getText().toString(), year.getText().toString()))
